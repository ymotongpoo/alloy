...
func TestQuerySamples(t *testing.T) {
	...
	testcases := []struct {
	...
	}{
		{
			...
			logsLabels: []model.LabelSet{
				{"op": OP_QUERY_SAMPLE},
				{"op": OP_QUERY_SAMPLE_V2, "schema": "some_schema"},
			},
			logsLines: []string{
				...
				"level=\"info\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" event_id=\"123\" end_event_id=\"234\" rows_examined=\"5\" rows_sent=\"5\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"456b\" max_total_memory=\"457b\" cpu_time=\"0.010000ms\" elapsed_time=\"0.020000ms\" elapsed_time_ms=\"0.020000ms\"",
			},
		},
		{
			...
			logsLabels: []model.LabelSet{
				...
				{"op": OP_QUERY_SAMPLE_V2, "schema": "some_schema"},
				{"op": OP_QUERY_SAMPLE},
				{"op": OP_QUERY_SAMPLE_V2, "schema": "some_other_schema"},
			},
			logsLines: []string{
				"level=\"info\" schema=\"some_schema\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" event_id=\"123\" end_event_id=\"234\" digest=\"some_digest\" rows_examined=\"5\" rows_sent=\"5\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"456b\" max_total_memory=\"457b\" cpu_time=\"0.010000ms\" elapsed_time=\"0.020000ms\" elapsed_time_ms=\"0.020000ms\"",
				"level=\"info\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" event_id=\"123\" end_event_id=\"234\" rows_examined=\"5\" rows_sent=\"5\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"456b\" max_total_memory=\"457b\" cpu_time=\"0.010000ms\" elapsed_time=\"0.020000ms\" elapsed_time_ms=\"0.020000ms\"",
				...
				"level=\"info\" user=\"some_user\" client_host=\"some_host\" thread_id=\"891\" event_id=\"124\" end_event_id=\"235\" rows_examined=\"5\" rows_sent=\"5\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"456b\" max_total_memory=\"457b\" cpu_time=\"0.010000ms\" elapsed_time=\"0.020000ms\" elapsed_time_ms=\"0.020000ms\"",
			},
		},
	}
...
func TestQuerySamples_WaitEvents(t *testing.T) {
	t.Run("both query sample and associated wait event is collected", func(t *testing.T) {
		...
		assert.Equal(t, model.LabelSet{"op": OP_QUERY_SAMPLE_V2, "schema": "some_schema"}, lokiEntries[1].Labels)
		assert.Equal(t, "level=\"info\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" event_id=\"123\" end_event_id=\"234\" rows_examined=\"5\" rows_sent=\"5\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"456b\" max_total_memory=\"457b\" cpu_time=\"0.010000ms\" elapsed_time=\"0.020000ms\" elapsed_time_ms=\"0.020000ms\"", lokiEntries[1].Line)
		assert.Equal(t, model.LabelSet{"op": OP_WAIT_EVENT}, lokiEntries[2].Labels)
		assert.Equal(t, "level=\"info\" schema=\"some_schema\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" digest=\"some_digest\" event_id=\"123\" wait_event_id=\"124\" wait_end_event_id=\"124\" wait_event_name=\"wait/io/file/innodb/innodb_data_file\" wait_object_name=\"wait_object_name\" wait_object_type=\"wait_object_type\" wait_time=\"0.100000ms\"", lokiEntries[2].Line)
		assert.Equal(t, model.LabelSet{"op": OP_WAIT_EVENT_V2, "schema": "some_schema"}, lokiEntries[3].Labels)
		assert.Equal(t, "level=\"info\" thread_id=\"890\" event_id=\"123\" wait_event_id=\"124\" wait_end_event_id=\"124\" wait_object_type=\"wait_object_type\" wait_object_name=\"wait_object_name\" wait_time=\"0.100000ms\"", lokiEntries[3].Line)
	})
	...
	t.Run("query sample and multiple wait events are collected", func(t *testing.T) {
		...
		assert.Equal(t, model.LabelSet{"op": OP_QUERY_SAMPLE_V2, "schema": "books_store"}, lokiEntries[1].Labels)
		assert.Equal(t, "level=\"info\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" event_id=\"123\" end_event_id=\"234\" rows_examined=\"5\" rows_sent=\"5\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"456b\" max_total_memory=\"457b\" cpu_time=\"0.010000ms\" elapsed_time=\"0.020000ms\" elapsed_time_ms=\"0.020000ms\"", lokiEntries[1].Line)
		assert.Equal(t, model.LabelSet{"op": OP_WAIT_EVENT}, lokiEntries[2].Labels)
		assert.Equal(t, "level=\"info\" schema=\"books_store\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" digest=\"some_digest\" event_id=\"123\" wait_event_id=\"124\" wait_end_event_id=\"125\" wait_event_name=\"wait/lock/table/sql/handler\" wait_object_name=\"books\" wait_object_type=\"TABLE\" wait_time=\"0.000150ms\"", lokiEntries[2].Line)
		assert.Equal(t, model.LabelSet{"op": OP_WAIT_EVENT_V2, "schema": "books_store"}, lokiEntries[3].Labels)
		...
		assert.Equal(t, model.LabelSet{"op": OP_WAIT_EVENT_V2, "schema": "books_store"}, lokiEntries[5].Labels)
		assert.Equal(t, model.LabelSet{"op": OP_WAIT_EVENT}, lokiEntries[6].Labels)
		assert.Equal(t, "level=\"info\" schema=\"books_store\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" digest=\"some_digest\" event_id=\"123\" wait_event_id=\"127\" wait_end_event_id=\"127\" wait_event_name=\"wait/io/table/sql/handler\" wait_object_name=\"books\" wait_object_type=\"TABLE\" wait_time=\"0.000500ms\"", lokiEntries[6].Line)
		assert.Equal(t, model.LabelSet{"op": OP_WAIT_EVENT_V2, "schema": "books_store"}, lokiEntries[7].Labels)
		assert.Equal(t, model.LabelSet{"op": OP_WAIT_EVENT}, lokiEntries[8].Labels)
		assert.Equal(t, "level=\"info\" schema=\"books_store\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" digest=\"some_digest\" event_id=\"123\" wait_event_id=\"128\" wait_end_event_id=\"128\" wait_event_name=\"wait/io/table/sql/handler\" wait_object_name=\"categories\" wait_object_type=\"TABLE\" wait_time=\"0.000700ms\"", lokiEntries[8].Line)
		assert.Equal(t, model.LabelSet{"op": OP_WAIT_EVENT_V2, "schema": "books_store"}, lokiEntries[9].Labels)
	})
	...
	t.Run("query sample and its wait event and another query sample are collected", func(t *testing.T) {
		...
		assert.Equal(t, model.LabelSet{"op": OP_QUERY_SAMPLE_V2, "schema": "books_store"}, lokiEntries[5].Labels)
		assert.Equal(t, "level=\"info\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" event_id=\"126\" end_event_id=\"234\" rows_examined=\"5\" rows_sent=\"5\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"456b\" max_total_memory=\"457b\" cpu_time=\"0.010000ms\" elapsed_time=\"0.020000ms\" elapsed_time_ms=\"0.020000ms\"", lokiEntries[5].Line)
	})
	...
	t.Run("wait event with disabled sql redaction", func(t *testing.T) {
		...
		assert.Equal(t, model.LabelSet{"op": OP_QUERY_SAMPLE_V2, "schema": "some_schema"}, lokiEntries[1].Labels)
		assert.Equal(t, "level=\"info\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" event_id=\"123\" end_event_id=\"234\" rows_examined=\"5\" rows_sent=\"5\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"456b\" max_total_memory=\"457b\" cpu_time=\"0.010000ms\" elapsed_time=\"0.020000ms\" elapsed_time_ms=\"0.020000ms\" sql_text=\"select * from some_table where id = 1\"", lokiEntries[1].Line)
		assert.Equal(t, model.LabelSet{"op": OP_WAIT_EVENT}, lokiEntries[2].Labels)
		assert.Equal(t, "level=\"info\" schema=\"some_schema\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" digest=\"some_digest\" event_id=\"123\" wait_event_id=\"124\" wait_end_event_id=\"125\" wait_event_name=\"wait/io/file/innodb/innodb_data_file\" wait_object_name=\"wait_object_name\" wait_object_type=\"wait_object_type\" wait_time=\"0.100000ms\" sql_text=\"select * from some_table where id = 1\"", lokiEntries[2].Line)
		assert.Equal(t, model.LabelSet{"op": OP_WAIT_EVENT_V2, "schema": "some_schema"}, lokiEntries[3].Labels)
		assert.Equal(t, "level=\"info\" thread_id=\"890\" event_id=\"123\" wait_event_id=\"124\" wait_end_event_id=\"125\" wait_object_type=\"wait_object_type\" wait_object_name=\"wait_object_name\" wait_time=\"0.100000ms\" sql_text=\"select * from some_table where id = 1\"", lokiEntries[3].Line)
	})
...
func TestQuerySamples_DisableQueryRedaction(t *testing.T) {
	...
	t.Run("collects sql text when enabled", func(t *testing.T) {
		...
		require.Equal(t, model.LabelSet{"op": OP_QUERY_SAMPLE_V2, "schema": "some_schema"}, lokiEntries[1].Labels)
		require.Equal(t, "level=\"info\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" event_id=\"123\" end_event_id=\"234\" rows_examined=\"5\" rows_sent=\"5\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"456b\" max_total_memory=\"457b\" cpu_time=\"0.010000ms\" elapsed_time=\"0.020000ms\" elapsed_time_ms=\"0.020000ms\" sql_text=\"select * from some_table where id = 1\"", lokiEntries[1].Line)
	})
	...
	t.Run("does not collect sql text when disabled", func(t *testing.T) {
		...
		require.Equal(t, "level=\"info\" schema=\"some_schema\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" event_id=\"123\" end_event_id=\"234\" digest=\"some_digest\" rows_examined=\"5\" rows_sent=\"5\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"456b\" max_total_memory=\"457b\" cpu_time=\"0.010000ms\" elapsed_time=\"0.020000ms\" elapsed_time_ms=\"0.020000ms\"", lokiEntries[0].Line)
		require.Equal(t, model.LabelSet{"op": OP_QUERY_SAMPLE_V2, "schema": "some_schema"}, lokiEntries[1].Labels)
		require.Equal(t, "level=\"info\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" event_id=\"123\" end_event_id=\"234\" rows_examined=\"5\" rows_sent=\"5\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"456b\" max_total_memory=\"457b\" cpu_time=\"0.010000ms\" elapsed_time=\"0.020000ms\" elapsed_time_ms=\"0.020000ms\"", lokiEntries[1].Line)
	})
}
...
func TestQuerySamplesMySQLVersions(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedLogOutputV2: `level="info" user="some_user" client_host="some_host" thread_id="890" event_id="123" end_event_id="234" rows_examined="5" rows_sent="5" rows_affected="0" errors="0" max_controlled_memory="0b" max_total_memory="0b" cpu_time="0.000000ms" elapsed_time="0.020000ms" elapsed_time_ms="0.020000ms"`,
		...
		},
		{
			...
			expectedLogOutputV2: `level="info" user="some_user" client_host="some_host" thread_id="890" event_id="123" end_event_id="234" rows_examined="5" rows_sent="5" rows_affected="0" errors="0" max_controlled_memory="0b" max_total_memory="0b" cpu_time="0.010000ms" elapsed_time="0.020000ms" elapsed_time_ms="0.020000ms"`,
			expectedSchema:      "test_schema",
			scanValues: []driver.Value{
				"test_schema",
				"890",
		...
		},
		{
			...
			expectedLogOutputV2: `level="info" user="some_user" client_host="some_host" thread_id="890" event_id="123" end_event_id="234" rows_examined="5" rows_sent="5" rows_affected="0" errors="0" max_controlled_memory="1024b" max_total_memory="2048b" cpu_time="0.010000ms" elapsed_time="0.020000ms" elapsed_time_ms="0.020000ms"`,
			expectedSchema:      "test_schema",
			scanValues: []driver.Value{
				"test_schema",
				"890",
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			require.Equal(t, model.LabelSet{"op": OP_QUERY_SAMPLE_V2, "schema": model.LabelValue(tc.expectedSchema)}, lokiEntries[1].Labels)
			require.Equal(t, tc.expectedLogOutputV2, lokiEntries[1].Line)
		})
	}
}
...
func TestQuerySamples_handles_timer_overflows(t *testing.T) {
	t.Run("selects query sample summary: first run uses initialized timerBookmark and uptime limit", func(t *testing.T) {
		...
		assert.Equal(t, model.LabelSet{
			"op": OP_QUERY_SAMPLE_V2, "schema": "test_schema",
		}, lokiClient.Received()[1].Labels)
		assert.Equal(t, "level=\"info\" user=\"some_user\" client_host=\"some_host\" thread_id=\"890\" event_id=\"123\" end_event_id=\"234\" rows_examined=\"1000\" rows_sent=\"100\" rows_affected=\"0\" errors=\"0\" max_controlled_memory=\"1048576b\" max_total_memory=\"2097152b\" cpu_time=\"0.000556ms\" elapsed_time=\"2000.000000ms\" elapsed_time_ms=\"2000.000000ms\"", lokiClient.Received()[1].Line)
	})
